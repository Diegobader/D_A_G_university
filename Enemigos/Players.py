...
def main(resolution,sprite,fondo):
    screen = pygame.display.set_mode(resolution)
    clock = pygame.time.Clock()
    player = PJ((0,0),sprite)
    fondo1=Fondo('Images/Others/1_11.png',0,0,resolution)
    fondo2=Fondo('Images/Others/1_12.png',resolution[0],0,resolution)
    fondo3=Fondo('Images/Others/1_13.png',resolution[0]*2,0,resolution)
    while True:
        time=clock.tick(60)
        key=pygame.key.get_pressed()
        ...
        background=pygame.transform.scale(pygame.image.load(fondo).convert(), resolution)
